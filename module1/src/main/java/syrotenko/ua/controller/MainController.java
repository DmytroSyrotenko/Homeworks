...
public class MainController {
    ...
    private void menu() {
        ...
        System.out.println("If you want FIND ALL GROUPS AND STUDENTS please enter 17");
        System.out.println();
    ...
    private void crud(String position, BufferedReader bufferedReader) throws IOException {
        switch (position) {
            ...
            case "16" -> deleteStudentFromGroup(bufferedReader);
            case "17" -> findAllGroupsAndStudents();
